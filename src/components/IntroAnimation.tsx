      ...
      <div className="relative flex flex-col items-center">
        ...
        >
          <h1 className="text-center">
            <span className="block text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight">
              Lee Jieyn Hair
            </span>
            <span className="block mt-3 text-lg sm:text-xl text-white/70 tracking-[0.2em]">
              컷 & 펌 전문
            </span>
          </h1>
        </div>
        ...
        >
          <p className="text-white/50 text-sm tracking-widest">이지은헤어 · 관양시장</p>
        </div>
      </div>
    </div>
  );
